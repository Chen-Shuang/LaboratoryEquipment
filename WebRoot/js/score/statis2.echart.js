...
require(
	...
	showSGBar = function(startTime,endTime,policename,policeid,dwid) {
		/*各种类型的数据量*/
	 	$.post("hstatis/list",{startTime:startTime,endTime:endTime,policename:policename,policeid:policeid,dwid:dwid},function(data){
	...
	showSGBar2 = function(startTime,endTime,policename,policeid,dwid) {
		/*各种类型的数据量*/
	 	$.post("hscore/list",{startTime:startTime,endTime:endTime,policename:policename,policeid:policeid,dwid:dwid},function(data){
			//根据单位列表长度，确定页面中div高度300px起价
		var t = data.dwmcData.length;
		var h = 300+(t-1)*20;
